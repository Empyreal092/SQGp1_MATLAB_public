function [u,v] = UV_sqgp1(b_k,Ro,ikx_,iky_,K_,IK_,aa_filter)
...
if Ro ~= 0
    ...
    u = -psiy.*(1+Ro*bz)-2*Ro*by.*b...
        + Ro*ifft2_n(iky_.*Sk + Ryk,'symmetric');
    v =  psix.*(1+Ro*bz)+2*Ro*bx.*b...
        - Ro*ifft2_n(ikx_.*Sk + Rxk,'symmetric');
    
%     Ro2_err = b_k_mean-bbz_k(1,1);
else
    u = -psiy;
    v =  psix;
